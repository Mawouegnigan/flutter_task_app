...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LoginScreen(), //AddEditingTaskScreen(mode: 'Edit'),  // OnboardingScreen() SplashScreen() LoginScreen() RegisterScreen() HomeScreen() AddEditingTaskScreen(mode: [Add, Edit])
    );
  }
}
