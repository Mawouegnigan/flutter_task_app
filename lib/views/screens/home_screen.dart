        ...
        children: [
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: TextField(
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(color: AppColors.textDarkSecondary, fontSize: 14),
                      prefixIcon: Icon(Icons.search),
                      suffixIcon:  IconButton(
                        icon: const Icon(Icons.close_rounded),
                        onPressed: () {}, // action à definir pour le tap sur le boutton de suppression du champ de recherche
                      ),
                      enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(16),
                        borderSide: BorderSide(color: colorScheme.outlineVariant.withAlpha(50), width: 1.5),
                      ),
                ...
                ViewToggleButtonWidget(
                  isGrid: true, 
                  onTap: () {} // Action à definir pour le tap sur le bouton de toggle
                )
              ],
            ),
          ),
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                ...[
                  TaskModel(id: 'all', title: 'Toutes les tâches', selected: true),
